 ...
 *  Impl all with handcrafted test file and refactor to make sense
 *
 * Debug the images generated by draw_rect listings
 * 8088 cycles
 * Refac to shorter local vars for read data (Casey style)
 * Implement exceptions
 * Add missing instructions (esc)
 * Look for reference emu's/try to run locally/verify typos in manual
