...
INSTALT(mov, {B(100011), D, B(0), MOD, B(0), SR, RM, IMP_W(1)})
...
INSTALT(and, {B(100000), S, W, MOD, B(100), RM, DATA, DATA_IF_W, IMP_D(0)})
...
INSTALT(or, {B(100000), S, W, MOD, B(001), RM, DATA, DATA_IF_W, IMP_D(0)})
INSTALT(or, {B(0000110), W, DATA, DATA_IF_W, IMP_REG(0), IMP_D(1)})

INST   (xor, {B(001100), D, W, MOD, REG, RM})
INSTALT(xor, {B(100000), S, W, MOD, B(110), RM, DATA, DATA_IF_W, IMP_D(0)})
