...
/* @TODO:
 * Remake mov to table lookup + tighten up table and code (inc pull table to sep file)
...
static const instr_t instruction_info[] =
{
    {
        .cls  = e_ic_mov,
    ...
    },
    {
        ...
        .desc = {
            ...
            .requires_second_byte = false, // @TODO: check
...
int main(int argc, char **argv)
{
    ...
    for (;;) {
        ...
        TRY_ELSE_GOTO(fetch_integer_with_endian_swap(f, &first_byte), loop_breakout);
        */
