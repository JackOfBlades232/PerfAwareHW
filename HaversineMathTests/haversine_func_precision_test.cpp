    ...
    for (auto [f, rf, tr_min, tr_max, tcnt, nm, rnm, allowed_err] :
        {
            ...
            RTEST(sin_taylor_approx_fmadd<2>, sin, -2.0 * c_pi, 2.0 * c_pi, 1024, f64(FLT_EPSILON)),
            RTEST(sin_taylor_approx_no_horner<2>, sin, -2.0 * c_pi, 2.0 * c_pi, 1024, f64(FLT_EPSILON)),
            RTEST(sin_taylor_approx_bw<2>, sin, -2.0 * c_pi, 2.0 * c_pi, 1024, f64(FLT_EPSILON)),
            RTEST(sin_taylor_approx<5>, sin, -2.0 * c_pi, 2.0 * c_pi, 1024, f64(FLT_EPSILON)),
            RTEST(sin_taylor_approx_fmadd<5>, sin, -2.0 * c_pi, 2.0 * c_pi, 1024, f64(FLT_EPSILON)),
            RTEST(sin_taylor_approx_no_horner<5>, sin, -2.0 * c_pi, 2.0 * c_pi, 1024, f64(FLT_EPSILON)),
            RTEST(sin_taylor_approx_bw<5>, sin, -2.0 * c_pi, 2.0 * c_pi, 1024, f64(FLT_EPSILON)),
            RTEST(sin_taylor_approx<8>, sin, -2.0 * c_pi, 2.0 * c_pi, 1024, f64(FLT_EPSILON)),
            RTEST(sin_taylor_approx_fmadd<8>, sin, -2.0 * c_pi, 2.0 * c_pi, 1024, f64(FLT_EPSILON)),
            RTEST(sin_taylor_approx_no_horner<8>, sin, -2.0 * c_pi, 2.0 * c_pi, 1024, f64(FLT_EPSILON)),
            RTEST(sin_taylor_approx_bw<8>, sin, -2.0 * c_pi, 2.0 * c_pi, 1024, f64(FLT_EPSILON)),
            RTEST(sin_taylor_approx<9>, sin, -2.0 * c_pi, 2.0 * c_pi, 1024, f64(FLT_EPSILON)),
            RTEST(sin_taylor_approx_fmadd<9>, sin, -2.0 * c_pi, 2.0 * c_pi, 1024, f64(FLT_EPSILON)),
            RTEST(sin_taylor_approx_no_horner<9>, sin, -2.0 * c_pi, 2.0 * c_pi, 1024, f64(FLT_EPSILON)),
            RTEST(sin_taylor_approx_bw<9>, sin, -2.0 * c_pi, 2.0 * c_pi, 1024, f64(FLT_EPSILON)),
            RTEST(sin_taylor_approx<11>, sin, -2.0 * c_pi, 2.0 * c_pi, 1024, f64(FLT_EPSILON)),
            RTEST(sin_taylor_approx_fmadd<11>, sin, -2.0 * c_pi, 2.0 * c_pi, 1024, f64(FLT_EPSILON)),
            RTEST(sin_taylor_approx_no_horner<11>, sin, -2.0 * c_pi, 2.0 * c_pi, 1024, f64(FLT_EPSILON)),
            RTEST(sin_taylor_approx_bw<11>, sin, -2.0 * c_pi, 2.0 * c_pi, 1024, f64(FLT_EPSILON)),
            RTEST(sin_taylor_approx<16>, sin, -2.0 * c_pi, 2.0 * c_pi, 1024, f64(FLT_EPSILON)),
            RTEST(sin_taylor_approx_fmadd<16>, sin, -2.0 * c_pi, 2.0 * c_pi, 1024, f64(FLT_EPSILON)),
            RTEST(sin_taylor_approx_no_horner<16>, sin, -2.0 * c_pi, 2.0 * c_pi, 1024, f64(FLT_EPSILON)),
            RTEST(sin_taylor_approx_bw<16>, sin, -2.0 * c_pi, 2.0 * c_pi, 1024, f64(FLT_EPSILON)),
            RTEST(sin_taylor_approx<17>, sin, -2.0 * c_pi, 2.0 * c_pi, 1024, f64(FLT_EPSILON)),
            RTEST(sin_taylor_approx_fmadd<17>, sin, -2.0 * c_pi, 2.0 * c_pi, 1024, f64(FLT_EPSILON)),
            RTEST(sin_taylor_approx_no_horner<17>, sin, -2.0 * c_pi, 2.0 * c_pi, 1024, f64(FLT_EPSILON)),
            RTEST(sin_taylor_approx_bw<17>, sin, -2.0 * c_pi, 2.0 * c_pi, 1024, f64(FLT_EPSILON)),

            RTEST(cos_taylor_approx_fmadd<2>, cos, -2.0 * c_pi, 2.0 * c_pi, 1024, f64(FLT_EPSILON)),
            RTEST(cos_taylor_approx_fmadd<8>, cos, -2.0 * c_pi, 2.0 * c_pi, 1024, f64(FLT_EPSILON)),
            RTEST(cos_taylor_approx_fmadd<11>, cos, -2.0 * c_pi, 2.0 * c_pi, 1024, f64(FLT_EPSILON)),
            RTEST(cos_taylor_approx_fmadd<16>, cos, -2.0 * c_pi, 2.0 * c_pi, 1024, f64(FLT_EPSILON)),
            RTEST(cos_taylor_approx_fmadd<17>, cos, -2.0 * c_pi, 2.0 * c_pi, 1024, f64(FLT_EPSILON)),
