...
clang-cl /Zi /arch:AVX2 /clang:-masm=intel /clang:-fno-vectorize /clang:-fno-slp-vectorize /Oi %* /std:c++20 /I..\..\Common /I..\..\Haversine\Components ..\dependency_chains.cpp /Fe: dependency_chains.exe
popd
